...
7273
 */
object problem067 extends problem018 {
  val path = getClass.getResourceAsStream("problem067-triangle.txt")
  override val mainInput = parse(io.Source.fromInputStream(path).mkString)
}
